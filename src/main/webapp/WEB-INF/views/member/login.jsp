...
<body>
			...
			<div>
				...
				<form id="loginForm" method="post">
					...
					<div style="display: flex; align-items: center;">
						...
						<div>
							<button type="submit" formaction="/member/login.do"
					...
					<p class="blue"
						...
						<button onclick="openPopup2()"
							style="border: none; background: none; cursor: pointer;">
							비밀번호찾기</button>&nbsp;&nbsp;/&nbsp;&nbsp;
						<button type="submit" formaction="/admin/login.do" style ="border:none;">
								<img src="/resources/images/egg.png" width="14" height="14" alt="관리자">
							</button>
					</p>
				</form>
	...
	<div class="section5" style="background-color: #3a4b3b;">
		<div class="downimg">
			...
			<img src="/resources/images/adver/ad5.png"
