...
<%@ page import="homepage.ApiCaller"%>
...
<link rel="icon" href="../images/icon/clearicon.ico" type="image/x-icon">
...
<script>
	function list(page) {
		location.href = "/cinema/cboard_servlet/list.do?cur_page=" + page
...
<body>
	<div class="section1">
		...
		<header>
			...
			<div class="logo">
				<a href="home.jsp"><img src="../images/icon/mainlogo2black.png"
			...
			<c:choose>
				<c:when test='${sessionScope.userid==null}'>
					<div class="main-menu">
						<a href="../member/login.jsp"><img
							src="../images/icon/login white.png"><br>로그인</a> | <a
							href="../member/register.jsp"><img
							src="../images/icon/join white.png"><br>회원가입</a> | <a
							href="../member/login.jsp"><img
							src="../images/icon/mypage white.png"><br>마이페이지</a> | <a
							href="../cboard/customercenter.jsp"><img
							src="../images/icon/callcenter white.png"><br>고객센터</a>
					</div>
				</c:when>
				<c:otherwise>
					<div class="main-menu">
						${sessionScope.name}님 환영합니다. <a
							href="../register_servlet/logout.do"><img
							src="../images/icon/logout white.png"><br>로그아웃</a> |<a
							href="../mypage_servlet/detail.do"><img
							src="../images/icon/mypage white.png"><br>마이페이지</a> | <a
							href="../cboard/customercenter.jsp"><img
							src="../images/icon/callcenter white.png"><br>고객센터</a>
					</div>
			...
			<ul>
				<li><a href="#" onmouseover="showMenu(1)"
					...
					<ul class="submenu" id="submenu1" onmouseover="keepShow(1)"
						...
						<li><a href="../main/moviechart.jsp">영화먼저</a></li>
						<li><a href="../main/findcinema.jsp">극장먼저</a></li>
					</ul></li>
				<li><a href="../main/moviechart.jsp" onmouseover="showMenu(2)"
					...
					<ul class="submenu" id="submenu2" onmouseover="keepShow(2)"
						...
						<li><a href="../main/moviechart.jsp">영화 예매</a></li>
						<li><a href="../main/moviechart.jsp">상영중인 영화</a></li>
					</ul></li>
				<li><a href="../main/findcinema.jsp" onmouseover="showMenu(3)"
					...
					<ul class="submenu" id="submenu3" onmouseover="keepShow(3)"
						...
						<li><a href="../main/findcinema.jsp">극장 예매</a></li>
						<li><a href="../main/findcinema.jsp">쌍용시네마 찾기</a></li>
					</ul></li>
	...
	<div class="section2" style="margin-top: 20px; margin-bottom: 20px;">
		...
		<div style="display: flex; justify-content: center;">
			<div class="menu-item">
                <input type="button" id="noti" value="공지사항" onclick="location.href='../cboard/index.jsp'">
            </div>
            <div class="menu-item">
                <input type="button" id="qna" value="자주 묻는 질문" onclick="location.href='../cboard/qnaindex.jsp'">
            </div>
		</div>
	</div>
	<div>
		<div class="titleword">공지사항</div>
		
		   <div class="search-form">
		<form name="form1" method="post"  action="/cinema/cboard_servlet/search.do">
		...
		<table border="1" width="900px">
			...
			<c:forEach var="dto" items="${list}">
				<c:if test="${dto.type == 1}">
					<tr align="center" class="highlight-row" onclick="location.href='/cinema/cboard_servlet/view.do?num=${dto.num}'">
						<td>${dto.num}</td>
						<td><c:choose>
	...
	<div class="section4" style="margin-top: 3cm;">
		<div class="soje"
		...
		<div class="adimg" style="text-align: center;">
			<button onclick="#"
				...
				<img src="../images/adver/ad1.png"
					style="width: 350px; height: 350px; margin: 0 20px">
			</button>
			<button onclick="#"
				style="border: none; background: none; cursor: pointer;">
				<img src="../images/adver/ad2.png"
					style="width: 350px; height: 350px; margin: 0 20px">
			</button>
			<button onclick="#"
				style="border: none; background: none; cursor: pointer;">
				<img src="../images/adver/ad3.png"
					style="width: 350px; height: 350px; margin: 0 20px">
			</button>
		</div>
		<div
