    ...
    <script>
        $(function(){
            $("#btnWrite").click(function(){
                location.href="/admin/eventwrite.do";
            });
        });
        function delete_event(num) {
        	if (confirm("삭제하시겠습니까?")) {
        		location.href="/admin/eventdelete.do?num="+num;
...
<body>
    ...
    <h2>이벤트</h2>
    <form name="form1" method="post" action="/cinema/event_servlet/search.do">
    ...
    <table border="1" width="900px">
        ...
        <c:forEach var="dto" items="${list}">
            <tr align="center">
                ...
                <td>${dto.type}</td>
                <td align="left">
                    <a href="/admin/view.do?num=${dto.num}">${dto.subject}</a>
                </td>
                <td>${dto.reg_date}</td>
                <td><img src="/cinema/images/${dto.filename1}" width="100px" height="100px"></td>
                <td>
