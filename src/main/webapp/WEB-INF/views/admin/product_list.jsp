...
function delete_product(product_code) {
	if (confirm("삭제하시겠습니까?")) {
		location.href="/admin/delete.do?product_code="+product_code;
	...
	<table border="1" width="500px">
        ...
        <c:when test="${row.product_type == 5}">
            굿즈
				...
				<td><img src="/cinema/images/${row.filename}" width="100px" height="100px"></td>
				<td><a href="/admin/edit.do?product_code=${row.product_code}">
